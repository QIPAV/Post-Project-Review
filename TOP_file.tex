...
\begin{titlepage}
    ...
    \begin{figure}[h]
        ...
        \\[2.0 cm] 
    \end{figure}                              
    \textsc{\Huge Post-Project Review}  
    \\[1 cm]
    \textsc{\Large }   
    \\[3.0 cm]
	\large \vapiqteam      
...
0.0       & $24.04.17$   & Created document and structure for document  & SF  & SF \\ 
...
\subfile{Sections/ReviewProjectPlan}
\newpage


\subfile{Sections/TimeManagement}
\newpage

\subfile{Sections/Challenges}
\newpage

\subfile{Sections/KeyLessonsLearnt}
\newpage

\subfile{Sections/GuidanceForFutureDevelopment}
\newpage

\subfile{Sections/Completion}
\newpage
